  ...
  const modeCards = [
    {
      ...
      title: "Playground",
      features: [
        "Tap keys to hear sounds",
        "See note names on keys",
        "Explore freely, no pressure",
      ],
    ...
    },
    {
      ...
      title: "Challenge",
      features: [
        "Pick the last note you heard",
        "Quit anytime, saves automatically",
        "Easy – White keys only",
        "Hard – All keys",
        "Global leaderboard",
      ],
